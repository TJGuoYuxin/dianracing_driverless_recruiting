...
get_filename_component(_filename "/home/aether/dianracing_ros_gyx/src/service/srv/abc.srv" NAME_WE)
add_custom_target(_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "service" "/home/aether/dianracing_ros_gyx/src/service/srv/abc.srv" ""
)
...
_generate_srv_cpp(service
  "/home/aether/dianracing_ros_gyx/src/service/srv/abc.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service\")")
  # install generated code
  install(
