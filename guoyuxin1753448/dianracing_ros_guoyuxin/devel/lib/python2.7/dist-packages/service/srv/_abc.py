...
"""autogenerated by genpy from service/abcRequest.msg. Do not edit."""
import sys
...
class abcRequest(genpy.Message):
  _md5sum = "c8559b52d432bccd240703f31aeca517"
  _type = "service/abcRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(abcRequest, self).__init__(*args, **kwds)
...
def _get_struct_3q():
    ...
    return _struct_3q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from service/abcResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class abcResponse(genpy.Message):
  _md5sum = "b88405221c77b1878a3cbbfff53428d7"
  _type = "service/abcResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(abcResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.sum is None:
        self.sum = 0
    else:
...
class abc(object):
  ...
  _request_class  = abcRequest
  _response_class = abcResponse
