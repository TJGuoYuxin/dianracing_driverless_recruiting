...
class abcRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type abcRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type abcRequest
    let len;
    let data = new abcRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new abcRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class abcResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type abcResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type abcResponse
    let len;
    let data = new abcResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new abcResponse(null);
